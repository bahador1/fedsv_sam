...
# print(f'Global accuracy has been saved to {accuracy_file_path}')
    ...
    file_name = f'{directory}/{args.dataset}_{args.model}_epoch[{args.epochs}]_Clients[{args.num_users}]_{args.noise}_fedavg_2attackrounds_iid_1attacker_scaling.pkl'
...
if __name__ == '__main__':
    ...
    for _ in range(repeat):
        ...
        filename = "Fedavg_sam_{}_cnn_E{}_N{}_gamma{}_repeat{}_{}.txt".format(args.dataset, args.epochs,
